...
public class Grafo {
    ...
    public String encontrarRutaMinimaDijkstra(char inicio, char fin) {
        ...
        return distancia + ": " + ruta;//return distancia + ": " + ruta;
    }
    ...
    private void recorrerRutas(int nodoI, int nodoF, Stack<Integer> resultado) {
        ...
        List<Integer> lista = new ArrayList<Integer>(); //**************************Se cambió de Vector<Integer>() a ArrayList
